...
use crate::term::tokens::{SpannedToken, Surface, Token};
use crate::r#type::parse::{parse_sort, parse_type, parse_type_primary, parse_type_variable_name};
use crate::r#type::tokens::{SpannedToken as TSpannedToken, Token as TToken};
...
fn parse_var<'a, E: ParseError<Span<'a>> + ContextError<Span<'a>>>(
    ...
    consumed(parse_variable_name.map(Token::Var))
